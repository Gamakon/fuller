...
fn main() {
    ...
    let islands = [
        Island { lo: 0, hi: intake, elites: 2, tournsize: (intake * 7 / 100).max(2), arrivals: 0, rates },
        Island { lo: intake, hi: pop, elites: 2, tournsize: ((pop - intake) * 7 / 100).max(2), arrivals: 0, rates },
    ];
