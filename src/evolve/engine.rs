...
impl Config {
    ...
    pub fn srbench(seed: u32) -> Config {
        ...
        Config {
            ...
            // ON, on the pump's beat -- Andrew, asked three times: "I've asked
            // you several times, please make it happen." A 400-generation A/B
            // was one win and two losses, which is a poor test of a benefit
            // aimed at a blob carried for 60,000 generations: on the seed that
            // won, train 1-R2 was TEN TIMES better with the fold on. It ships
            // on and the long runs judge it.
